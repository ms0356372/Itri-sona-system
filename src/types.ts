...
export interface HistoricalRecord {id?:number;fingerprint:string;employeeNo:string;name:string;year:number;date:string;type:string;result:string;sourceFile:string}
